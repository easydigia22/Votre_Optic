      ...
      <div className="space-y-4">
        {promotions.map((p) => {
          ...
          return (
            <div
              key={p.id}
              className="bg-[#151515] border border-white/5 p-4 sm:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4"
            >
              <div className="flex items-center gap-4">
                <div className="w-20 h-16 bg-[#0B0B0B] border border-white/10 shrink-0 overflow-hidden">
                  <img
                    src={p.bannerUrl}
                    alt={p.title}
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {p.code && (
                      <span className="font-mono text-[10px] text-[#D6AE62] bg-[#0B0B0B] px-1.5 py-0.2 border border-[#D6AE62]/30">
                        Code: {p.code}
                      </span>
                    )}
                    <span
                  ...
                  <p className="text-xs text-[#A6A6A6] line-clamp-1 max-w-xl">{p.description}</p>
                  <p className="text-[11px] text-[#D6AE62] mt-1">
              ...
              <div className="flex items-center gap-2 self-end md:self-center">
                <button
                  ...
                  className="p-2 text-[#A6A6A6] hover:text-[#D6AE62]"
                >
                ...
                <button
                  ...
                  className="p-2 text-[#A6A6A6] hover:text-red-400"
                >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
          <div className="w-full max-w-lg bg-[#151515] border border-[#D6AE62]/40 p-6 shadow-2xl relative my-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div>
                <label className="block text-[#A6A6A6] uppercase mb-1 font-semibold">Titre *</label>
                <input
                  type="text"
                  required
                  value={form.title}
