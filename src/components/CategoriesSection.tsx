          ...
          {activeCategories.map((cat) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-between z-10">
                ...
                <div>
                  <h3 className="font-serif-luxury text-2xl text-white font-medium group-hover:text-[#F5E6A6] transition-colors">
                    {cat.name}
                  </h3>
                  <p className="text-xs text-[#9F9A8E] mt-1 line-clamp-2 leading-relaxed">
                    {cat.description}
                  </p>
                </div>
              </div>
