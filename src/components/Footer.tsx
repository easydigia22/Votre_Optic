...
export const Footer: React.FC<FooterProps> = ({ settings, onNavigate }) => {
  ...
  return (
    <footer className="bg-[#080808] text-[#A6A6A6] border-t border-[#D6AE62]/20 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/5">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs text-[#A6A6A6] leading-relaxed max-w-sm pt-2">
            ...
            <div className="pt-2 flex items-center gap-3">
              {settings.socialLinks.instagram && (
                <a
                  ...
                  className="w-8 h-8 rounded-full bg-[#151515] border border-white/10 text-white hover:text-[#D6AE62] hover:border-[#D6AE62] flex items-center justify-center transition-colors"
                >
              ...
              {settings.socialLinks.whatsapp && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  className="w-8 h-8 rounded-full bg-[#151515] border border-[#D6AE62]/40 text-[#D6AE62] hover:bg-[#D6AE62] hover:text-[#0B0B0B] flex items-center justify-center transition-colors"
                >
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="hover:text-[#D6AE62] transition-colors"
                >
                  Accueil
                </button>
              </li>
          ...
          <div className="lg:col-span-3 space-y-3 text-xs">
            ...
            <div className="space-y-2.5">
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-[#D6AE62] shrink-0 mt-0.5" />
                <span className="text-white">
                  {settings.address}, {settings.city}, {settings.country}
                </span>
              </div>
              <div className="flex items-start gap-2">
                <Clock className="w-4 h-4 text-[#D6AE62] shrink-0 mt-0.5" />
                <span>{settings.hours}</span>
              </div>
              <div className="flex items-start gap-2">
                <Phone className="w-4 h-4 text-[#D6AE62] shrink-0 mt-0.5" />
                <a href={`tel:${cleanNumber}`} className="font-mono text-white hover:text-[#D6AE62]">
                  {settings.phone}
                </a>
              </div>
              <div className="flex items-start gap-2">
                <MessageCircle className="w-4 h-4 text-[#D6AE62] shrink-0 mt-0.5" />
                <a
                  href={`https://wa.me/${cleanNumber}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#E8C987] hover:underline font-mono"
                >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#737373]">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-[#A6A6A6] hover:text-[#D6AE62] transition-colors"
            >
              <ShieldCheck className="w-3.5 h-3.5 text-[#D6AE62]" />
