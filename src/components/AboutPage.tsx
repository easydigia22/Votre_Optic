    ...
    <div className="min-h-screen bg-[#0B0B0B] text-[#F8F5EF] pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-base text-[#CCCCCC] leading-relaxed font-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20 border-b border-white/10 pb-16">
          <div className="relative aspect-[4/3] bg-[#151515] overflow-hidden border border-[#D6AE62]/30">
            <img
            ...
            <div className="absolute bottom-6 left-6 right-6 p-4 bg-[#0B0B0B]/90 border border-[#D6AE62]/30 backdrop-blur-sm">
              <span className="text-[11px] font-mono text-[#D6AE62] uppercase tracking-wider block">
                Atelier & Précision
              </span>
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 grid grid-cols-2 gap-4 text-xs">
              <div className="p-4 bg-[#151515] border border-white/5">
                <span className="font-mono text-2xl font-bold text-[#D6AE62] block mb-1">100%</span>
                <span className="text-white font-medium block">Origine Certifiée</span>
                <span className="text-[11px] text-[#A6A6A6]">Montures officielles avec certificats d'authenticité</span>
              </div>
              <div className="p-4 bg-[#151515] border border-white/5">
                <span className="font-mono text-2xl font-bold text-[#D6AE62] block mb-1">+500</span>
                <span className="text-white font-medium block">Clients Fidèles</span>
                <span className="text-[11px] text-[#A6A6A6]">À travers tout le Royaume du Maroc</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-[#151515] border border-white/5 p-8 text-center space-y-3">
            <div className="w-12 h-12 rounded-full bg-[#0B0B0B] border border-[#D6AE62]/40 text-[#D6AE62] flex items-center justify-center mx-auto">
        ...
        {/* CTA Footer */}
        <div className="bg-[#151515] border border-[#D6AE62]/30 p-8 sm:p-12 text-center max-w-3xl mx-auto space-y-6">
          <h3 className="font-serif-luxury text-3xl text-white">
            Venez essayer vos futures lunettes à Casablanca
          </h3>
          <p className="text-xs sm:text-sm text-[#A6A6A6] max-w-xl mx-auto">
            {settings.address}, {settings.city} · Du Lundi au Samedi de 09h30 à 20h00
          </p>
          <div className="flex flex-wrap justify-center gap-4 pt-2">
            <button
              onClick={() => onNavigate('catalogue')}
              className="px-6 py-3 bg-[#D6AE62] hover:bg-[#E8C987] text-[#0B0B0B] font-bold text-xs uppercase tracking-wider"
            >
            ...
            <a
              ...
              className="px-6 py-3 bg-[#0B0B0B] border border-[#D6AE62]/40 text-[#F0D8A5] font-semibold text-xs uppercase tracking-wider flex items-center gap-2"
            >
